...
from mlproj_manager.util.data_preprocessing_and_transformations.image_transformations import ToTensor, Normalize
...
def main():
    ...
    experiment_parameters = {
        ...
        "weight_decay": 0.0001,    # 0.0000001 for cifar 10
        "momentum": 0.9,
