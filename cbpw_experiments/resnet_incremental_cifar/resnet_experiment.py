...
class ResNetIncrementalCIFARExperiment(IncrementalCIFARExperiment):
    ...
    def __init__(self, exp_params: dict, results_dir: str, run_index: int, verbose=True):
        ...
        self.bn_update_freq = access_dict(exp_params, "bn_update_freq", default=200, val_type=int)
        self.bn_drop_factor = access_dict(exp_params, "bn_drop_factor", default=0.2, val_type=float)
