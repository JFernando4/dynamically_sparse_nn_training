...
class IncrementalCIFARExperiment(Experiment):
    ...
    def __init__(self, exp_params: dict, results_dir: str, run_index: int, verbose=True):
        ...
        pruning_functions_names = ["none", "magnitude", "redo", "gf_redo"]
        grow_methods = ["none", "pm_min", "kaiming_normal", "xavier_normal", "zero", "kaming_uniform", "xavier_uniform"]
        ...
        assert not (self.prune_method != "none" and self.grow_method == "none") or not (self.prune_method == "none" and self.grow_method != "none")
    ...
    def _initialize_weight_dict(self) -> dict:
        ...
        ln_update_func = setup_cbpw_weight_update_function("magnitude", "fixed",
