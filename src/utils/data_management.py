...
def subsample_cifar_data_set(sub_sample_indices, cifar_data: CifarDataSet):
    ...
    cifar_data.current_data["data"] = cifar_data.current_data["data"][sub_sample_indices]
    cifar_data.current_data["labels"] = cifar_data.current_data["labels"][sub_sample_indices]
