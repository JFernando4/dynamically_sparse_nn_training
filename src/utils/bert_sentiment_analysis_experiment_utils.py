...
from transformers.trainer_utils import EvalPrediction, has_length, HPSearchBackend, TrainOutput, speed_metrics
from transformers.trainer_callback import TrainerCallback, TrainerState
from transformers.utils import logging, is_sagemaker_mp_enabled, is_accelerate_available, is_torch_xla_available, is_apex_available
...
class CBPWTrainer(Trainer):
    ...
    def _inner_training_loop(
        ...
        # ----- ----- ----- ----- where training actually starts ----- ----- ----- ----- #
