"""
Modification of pytorch's SGD optimizer that applies l1 and l2 regularization
"""
...
class RegularizedSGD(Optimizer):
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
                 weight_decay=0, l1_reg_factor=0, nesterov=False, *, maximize: bool = False,
        ...
        defaults = dict(lr=lr, momentum=momentum, dampening=dampening,
                        weight_decay=weight_decay, l1_reg_factor=l1_reg_factor, nesterov=nesterov,
...
def _single_tensor_sgd(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        if l1_reg_factor != 0:
            d_p = d_p.add(param.detach().sign(), alpha=l1_reg_factor)
