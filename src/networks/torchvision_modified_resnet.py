...
from src.networks.sequential_kw_arguments import SequentialWithKeywordArguments
...
# Not originally part of Torchvision but the functions mimic how the modules in the ResNet are initialized
