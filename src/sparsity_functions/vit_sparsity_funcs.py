...
def init_vit_weight_masks(net: VisionTransformer, sparsity_level: float, include_conv_proj: bool = False,
    ...
    if include_conv_proj:
        ...
        conv_proj_mask["is_layer_norm"] = False
    ...
    if include_class_token:
        ...
        class_token_mask["is_layer_norm"] = False
    ...
    if include_pos_embedding:
        ...
        pos_embedding_mask["is_layer_norm"] = False
    ...
    masks.extend(init_vit_encoder_masks(net.encoder, sparsity_level, include_msa, include_ln))
...
def init_vit_encoder_masks(mod: Encoder, sparsity_level: float, include_msa: bool = False, include_ln: bool = False):
    ...
    for e_block in mod.layers:
        ...
        masks.extend(init_encoder_block_masks(e_block, sparsity_level, include_msa, include_ln))

    if include_ln:
        last_ln_mask = {"module": mod.ln, "is_layer_norm": True}
        masks.append(last_ln_mask)
...
def init_encoder_block_masks(mod: EncoderBlock, sparsity_level: float, include_msa: bool = False,
    ...
    if include_msa:
        ...
        in_proj_mask["is_layer_norm"] = False
        ...
        out_proj_mask["is_layer_norm"] = False
    ...
    if include_ln:
        l1_mask = {"module": mod.ln_1, "is_layer_norm": True}
        l2_mask = {"module": mod.ln_2, "is_layer_norm": True}
        masks.extend([l1_mask, l2_mask])
