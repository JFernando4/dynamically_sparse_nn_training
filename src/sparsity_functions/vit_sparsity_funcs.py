...
# from torchvision.models.vision_transformer import VisionTransformer, EncoderBlock, Encoder
# src
from src.sparsity_functions.sparsity_funcs import init_weight_mask_from_tensor
from src.networks.torchvision_modified_vit import VisionTransformer, EncoderBlock, Encoder
